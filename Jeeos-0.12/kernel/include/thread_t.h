...
#define TD_NAME_MAX 16      /**< 线程名称最大长度 */
...
typedef struct s_THREAD {
    ...
    /* 进程关系 */
    struct s_THREAD *td_parent; /**< 父进程 */
    list_h_t td_children;       /**< 子进程链表头 */
    list_h_t td_sibling;        /**< 兄弟进程节点 */
    sint_t td_exit_code;        /**< 退出码 */
} thread_t;
