...
#define BUILD_KRNL_OBJS main.o vmem.o global.o mm.o mm_pages.o\
                        sem.o thread.o time.o wait_list.o\
                        sched.o cpu_idle.o device.o interrupt.o io_node.o 
#define BUILD_KSYS_OBJS syshandler.o sysmm.o systhread.o sysioctrl.o\
                        sysopen.o sysclose.o sysread.o syswrite.o\
                        syslseek.o 
#define BUILD_MEMY_OBJS
#define BUILD_FSYS_OBJS
#define BUILD_DRIV_OBJS timer.o ramfs.o serial.o nullzero.o
