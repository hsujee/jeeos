/*
 * @Author: Jee Hsu
 * @Description: 架构相关 - kmsob_t
 *
 * Copyright (c) 2025 Jee Hsu. SPDX-License-Identifier: MIT
 */
#ifndef ARCH_X86_SLAB_ALLOC_T_H
#define ARCH_X86_SLAB_ALLOC_T_H
...
typedef struct s_KMSOBMGRHED {
	...
	uint_t ks_tcnr;
	uint_t ks_msobnr;
	kmsob_t* ks_msobche;   //总共多少个kmsob_t结构
